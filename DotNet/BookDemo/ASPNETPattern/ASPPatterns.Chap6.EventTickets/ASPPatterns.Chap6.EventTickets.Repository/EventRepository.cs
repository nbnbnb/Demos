...
namespace ASPPatterns.Chap6.EventTickets.Repository
{
    public class EventRepository : IEventRepository
    {
        ...
        //    @"Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\EventTickets.mdf;"
        //    + @"Integrated Security=True;User Instance=True";

        private string connectionString = ConfigurationManager.ConnectionStrings["EventTickets"].ConnectionString;
