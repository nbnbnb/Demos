...
namespace CustomFormater
{
    public class MessageCompressionBehavior : IEndpointBehavior
    {
        ...
        public void ApplyClientBehavior(ServiceEndpoint endpoint, System.ServiceModel.Dispatcher.ClientRuntime clientRuntime)
        {
            ...
            {
                operation.Formatter =
                    new CompressionMessageFormatter(this.MessageCompressor, null, operation.Formatter);
            }
        }
        ...
        public void ApplyDispatchBehavior(ServiceEndpoint endpoint, System.ServiceModel.Dispatcher.EndpointDispatcher endpointDispatcher)
        {
            ...
            {
                operation.Formatter =
                    new CompressionMessageFormatter(this.MessageCompressor, operation.Formatter, null);
            }
        }
