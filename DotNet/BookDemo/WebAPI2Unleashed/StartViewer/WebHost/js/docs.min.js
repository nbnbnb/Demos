...
Holder.js is a JavaScript library that creates image placeholders for use in web design prototyping. 
Holder supports fixed-width and fluid-width placeholders, color and font themes, and fine grained control for procedural generation of placeholders. 
It's been a featured repository on Github, has been discussed on the Treehouse web development show, and is now the default placeholder library for the Twitter Bootstrap user interface toolkit.
